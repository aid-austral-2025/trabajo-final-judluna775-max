...
## Conclusiones del análisis anual

### 1. 2025 fue un año excepcional: varios acopios alcanzaron su mejor registro histórico
...
### 2. Acopios con crecimiento sostenido en los últimos 3 años (2023 → 2024 → 2025)
...
### 3. Impacto operativo de los cierres (2023–2024)
...
### 4. Acopios líderes que sostienen su posición

Más allá de los cambios anuales:

-   **GUARDIA ESCOLTA** y **PIQUETE CABADO** siguen siendo pilares fuertes del sistema.\
-   **ITIN** mantiene volúmenes estables y altos, consolidando su rol.

### 5. Acopios estructuralmente menores

-   **VICTORIA** muestra niveles bajos porque ya no pertenece al grupo.\
-   **VILLEGAS**, aún sin acopio físico, logra crecimiento destacable y consistente.

## Resumen ejecutivo

-   **2025 marca un año récord** para varios acopios claves.\
-   Las tendencias de crecimiento de los últimos 3 años muestran un **fortalecimiento sostenido**.\
-   Las caídas en 2023–2024 responden a factores operativos y no comerciales.\
-   El mapa productivo se reorganiza con acopios que crecen, otros que se recuperan y algunos que dejan el sistema.

Este análisis aporta una visión clara para la planificación comercial y operativa hacia adelante.
